...
import Partners from '@/components/Partners'; // Nova Secção
import Features from '@/components/Features';
import Stats from '@/components/Stats';       // Nova Secção
import Modules from '@/components/Modules';
import Testimonials from '@/components/Testimonials';
import Faq from '@/components/Faq';
import CallToAction from '@/components/CallToAction'; // Nova Secção
